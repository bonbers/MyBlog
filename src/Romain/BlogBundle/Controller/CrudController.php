...
use Romain\BlogBundle\Entity\Crud;
...
class CrudController extends Controller
{
    ...
    {
        $crud = new Crud();
        $form = $this->createForm('Romain\BlogBundle\Form\CrudType', $crud);
    ...
    {
        $deleteForm = $this->createDeleteForm($crud);
        $editForm = $this->createForm('Romain\BlogBundle\Form\CrudType', $crud);
